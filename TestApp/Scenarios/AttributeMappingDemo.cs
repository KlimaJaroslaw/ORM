...
/// <summary>
/// Demonstracja atrybut�w mapowania: [Table], [Column], [Key], [Ignore]
/// </summary>
public static class AttributeMappingDemo
{
    public static void Run()
    {
        Console.WriteLine("\n=== DEMONSTRACJA ATRYBUT�W MAPOWANIA ===\n");
        ...
        using (var context = new AppDbContext(configuration))
        {
            ...
            Console.WriteLine("   - W�a�ciwo�� 'Name' -> Kolumna 'product_name'");
            Console.WriteLine("   - W�a�ciwo�� 'CategoryId' -> Kolumna 'category_id'");
            
            Console.WriteLine("\n   Customer:");
            Console.WriteLine("   - W�a�ciwo�� 'FirstName' -> Kolumna 'first_name'");
            Console.WriteLine("   - W�a�ciwo�� 'LastName' -> Kolumna 'last_name'");
            Console.WriteLine("   - W�a�ciwo�� 'RegistrationDate' -> Kolumna 'registration_date'");

            Console.WriteLine("\n3. Atrybut [Key] - klucz g��wny:");
            Console.WriteLine("   Wszystkie encje maj� w�a�ciwo�� 'Id' jako klucz g��wny");
            ...
            Console.WriteLine("\n5. Atrybut [Ignore] - pomijanie w�a�ciwo�ci:");
            ...
            Console.WriteLine($"     W�a�ciwo�� 'FullName' (computed): {customer.FullName}");
            ...
            Console.WriteLine($"   Produkt ma przypisan� kategori�: {product.Category.Name}");
            Console.WriteLine($"   ? W�a�ciwo�� 'Category' NIE jest zapisywana w bazie");
        ...
        Console.WriteLine("\n=== Attribute Mapping Demo zako�czone ===");
    }
}

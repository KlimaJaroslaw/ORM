...
/// <summary>
/// Test weryfikujący optymalizację JOIN dla eager loading.
/// </summary>
public static class JoinOptimizationTest
{
    public static void Run()
    {
        ...
        const string dbPath = "join_optimization_test.db";
